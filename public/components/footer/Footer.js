              ...
              <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                <div className="edu-footer-widget quick-link-widget">
                  ...
                  <div className="inner">
                    <ul className="footer-link link-hover">
                      <li>
                        <Link to="/">Espace Client</Link>
                      </li>
                      <li>
                        <Link to="/pricing">Tarifs et modalités</Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="/course-1"> Popular Courses</Link>
                      </li>
                      <li>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="inner text-center">
                  <p style={{ color: "black" }}>
                    Sécurité <Link to={process.env.PUBLIC_URL + "/"} /> |
                    Sécurité <Link to={process.env.PUBLIC_URL + "/"} />
                  </p>
                </div>
              </div>
